...
class DatasetPayloadResponseTest extends AbstractPayloadResponseTest
{
    /**
     * {@inheritdoc}
     */
    ...
    {
    		$this->assertInstanceOf('Colada\Europeana\Payload\DatasetPayloadResponse', $payloadResponse);
